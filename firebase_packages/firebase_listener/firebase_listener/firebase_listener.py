...
cred = credentials.Certificate('/SSD/ros2_ws/src/firebase_packages/firebase_listener/firebase_listener/robot-receptionist-19-firebase-adminsdk-d2d0o-c6356ff7ef.json')
