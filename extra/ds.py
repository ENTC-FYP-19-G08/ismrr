...
def main():
    ...
    MODEL_PATH = os.path.join(os.getcwd(),"extra/models/deepspeech-0.9.3-models.pbmm")
    SCORER_PATH = os.path.join(os.getcwd(),"extra/models/deepspeech-0.9.3-models.scorer")

    print('Initializing model...')
    print("model: %s", MODEL_PATH)
    model = deepspeech.Model(MODEL_PATH)
    if SCORER_PATH:
        print("scorer: %s", SCORER_PATH)
