...
def generate_launch_description():
    ...
    slam_toolbox_package_dir = get_package_share_directory('slam_toolbox')
    ...
    start_slam_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(slam_toolbox_package_dir, 'launch', 'online_async_launch.py')),
        # launch_arguments={
        #                     'namespace': namespace,
        #                     'use_sim_time': use_sim_time,
        #                     # 'use_composition': 'True',
